...
distinction between true rollups (ARB, OP, LINEA, ZK) and sidechains. v3.0 places
POL in `smart_contract_platform` and the distinction is recorded in the exception
register.
