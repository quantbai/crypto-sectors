...
The v3 product is a deliberate pivot from the prior v2 product (a 4-tier MSCI-style
hierarchy on a 135-asset universe). That design is discarded. The v3 product is one
thing: a single flat `sector` field, 15 labels, anchored to the 232-coin OKX perpetual
universe, empirically validated for `group_neut`.
...
- `decisions/sector-field-okx-2026-06.md` — coin-by-coin audit record (the v3 source of placement rationale)
